...
export const SupabaseApi = {
  ...
  rpc(functionName, body = {}, useSession = true) {
    return httpRequest(`${getSupabaseBaseUrl()}/rest/v1/rpc/${functionName}`, {
      method: "POST",
  ...
  select(table, query = "", useSession = true) {
    ...
    return httpRequest(`${getSupabaseBaseUrl()}/rest/v1/${table}${suffix}`, {
      method: "GET",
  ...
  upsert(table, rows, onConflict = null, useSession = true) {
    ...
    return httpRequest(`${getSupabaseBaseUrl()}/rest/v1/${table}${query}`, {
      method: "POST",
