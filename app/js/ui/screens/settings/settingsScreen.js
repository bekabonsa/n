...
export const SettingsScreen = {
  ...
  renderAccountSection(model) {
    ...
    this.actionMap.set("account:signin", () => Router.navigate(getPrimarySignInRoute()));
    ...
    return `
      ...
      <div class="settings-group-card settings-group-card-fill">
        ...
        : `<p class="settings-account-note">${t("settings.account.syncNote")}</p>
          ...
          title: Platform.isBrowser()
            ? t("settings.account.signInBrowser", {}, "Sign In")
            : t("settings.account.signInWithQr"),
          subtitle: Platform.isBrowser()
            ? t("settings.account.signInBrowserSubtitle", {}, "Sign in to sync your addons, profiles, and resources.")
